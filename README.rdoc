...
2. Now, we have to create a controller for "posts", since this is a tumblr-like app.
...
5. Now go to the "routes.rb" file, inside "config" folder, and go for:

resources :posts
root "posts#index" (meaning posts controller index action)
